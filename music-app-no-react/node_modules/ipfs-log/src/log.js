...
class Log extends GSet {
  ...
  constructor (ipfs, identity, { logId, access, entries, heads, clock, sortFn, concurrency } = {}) {
    ...
    // Access Controller
    console.log("this is access._write: ", access._write)
    console.log("this is access.canAppend: ", access.canAppend)
    this._access = access
    // Identity
  ...
  async append (data, pointerCount = 1, pin = false) {
    ...
    console.log("this._identity.provider", this._identity.provider);
    if (!canAppend) {
